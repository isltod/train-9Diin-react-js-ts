...
export function AppFooter() {
  return (
    <footer className="w-full bg-stone-800 flex flex-col">
      <div className="w-full max-w-[1328px] flex flex-col gap-6 p-6 pb-18">
        <div className="w-full flex flex-col items-start justify-between gap-6 md:flex-row md:gap-0">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="icon" className="border-0">
                <img src="/assets/icons/icon-002.svg" alt="@SNS" className="w-6 mt-[2px]" />
              </Button>
              <Button variant="outline" size="icon" className="border-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="cursor-pointer transition-all duration-300 hover:font-medium">개인청보처리방침</p>
            <Separator orientation="vertical" className="!h-[14px]"/>
            <p className="cursor-pointer transition-all duration-300 hover:font-medium">클래스 론칭 문의</p>
          </div>
        </div>
        <Separator/>
        <div className="w-full flex flex-col justify-between md:flex-row md:gap-0">
          <div className="h-full flex flex-col justify-between">
            <div>
              <p className="h-10 text-base font-semibold">고객센터</p>
              <div className="flex flex-col items-start gap-1">
                <p>평일 오전 9시 ~ 오후 6시</p>
                <p>문의: wolf@teoal.net</p>
              </div>
            </div>
            <p>&copy; Mingo Team all rights reserved</p>
          </div>
